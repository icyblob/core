...
static void KeccakP1600_Permute_12roundsAVX512(unsigned char* state)
{
...
static void KangarooTwelve_F_AbsorbAVX512(KangarooTwelve_F* instance, const unsigned char* data, unsigned long long dataByteLen)
{
    unsigned long long i = 0;
    while (i < dataByteLen)
    {
...
static void KangarooTwelve64To32AVX512(const unsigned char* input, unsigned char* output)
{
